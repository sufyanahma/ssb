...
__author__ = 'Sarfraz'
__copyright = 'All rights reserved . Copyright  Sarfraz Baloch'
CorrectUsername = 'SSB'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
def animate():
    for c in itertools.cycle(['\x1b[1;91m||', '\x1b[1;92m/', '\x1b[1;93m\xe2\x94\x80', '\x1b[1;96m|', '\x1b[1;95m\\']):
        if done:
            break
        sys.stdout.write('\r\x1b[1;93m______SSB\x1b[1;94m:) ' + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c + c )  
        sys.stdout.flush()
        time.sleep(0.1)
...
\033[1;98m\033[1;98m Facebook :            SSB OFFICIAL
